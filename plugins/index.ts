...
import { handler as skillsHandbookhandbook } from './skills-handbook/handbook';
import { handler as toolObserverobserveTools } from './tool-observer/observeTools';
...
export const plugins = {
  ...
  'skills-handbook': {
    handbook: skillsHandbookhandbook,
  },
  'tool-observer': {
    observeTools: toolObserverobserveTools,
  },
};
